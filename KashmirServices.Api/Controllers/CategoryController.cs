...
public class CategoryController : ApiController
{
    ...
    [HttpGet("all-categories/{engineerid:guid}")]
    public async Task<IResult> GetAllCategoriesByEngineerId(Guid engineerid)
    {
        var result = await service.GetCategoriesByEngineerId(engineerid);
