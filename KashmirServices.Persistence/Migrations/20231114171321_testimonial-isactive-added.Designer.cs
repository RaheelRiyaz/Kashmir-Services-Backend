...
namespace KashmirServices.Persistence.Migrations
{
    ...
    [Migration("20231114171321_testimonial-isactive-added")]
    partial class testimonialisactiveadded
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("KashmirServices.Domain.Entities.Testimonial", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("KashmirServices.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConfirmationCode = "",
                            CreatedBy = new Guid("3a274c2f-6446-4a08-ba94-fee0c737f8a4"),
                            CreatedOn = new DateTimeOffset(new DateTime(2023, 11, 14, 22, 43, 20, 875, DateTimeKind.Unspecified).AddTicks(7115), new TimeSpan(0, 5, 30, 0, 0)),
                            ...
                            UpdatedBy = new Guid("dafd59b0-5cd9-4eda-b0b3-e35d59139d13"),
                            UpdatedOn = new DateTimeOffset(new DateTime(2023, 11, 14, 22, 43, 20, 875, DateTimeKind.Unspecified).AddTicks(7142), new TimeSpan(0, 5, 30, 0, 0)),
                            UserRole = 1,
                            UserStatus = 1,
                            Username = "admin"
                        });
            ...
            modelBuilder.Entity("KashmirServices.Domain.Entities.Testimonial", b =>
                {
                    b.HasOne("KashmirServices.Domain.Entities.User", "User")
