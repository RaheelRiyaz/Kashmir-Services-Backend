...
namespace KashmirServices.Persistence.Migrations
{
    ...
    [Migration("20231114170153_testimonialAdd")]
    partial class testimonialAdd
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("KashmirServices.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConfirmationCode = "",
                            CreatedBy = new Guid("9cf6c6a5-70a9-42cb-9fea-efe4d953817c"),
                            CreatedOn = new DateTimeOffset(new DateTime(2023, 11, 14, 22, 31, 52, 666, DateTimeKind.Unspecified).AddTicks(7348), new TimeSpan(0, 5, 30, 0, 0)),
                            ...
                            UpdatedBy = new Guid("83220c91-4dbb-43a3-bf47-9eb4c2068142"),
                            UpdatedOn = new DateTimeOffset(new DateTime(2023, 11, 14, 22, 31, 52, 666, DateTimeKind.Unspecified).AddTicks(7375), new TimeSpan(0, 5, 30, 0, 0)),
                            UserRole = 1,
                            UserStatus = 1,
                            Username = "admin"
                        });
