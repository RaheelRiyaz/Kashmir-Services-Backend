...
public class CategoryService : ICategoryService
{
    ...
    public async Task<APIResponse<IEnumerable<EngineerCategoryResposne>>> GetCategoriesByEngineerId(Guid engineerId)
    {
        var categories= await repository.GetCategoriesByEngineerId(engineerId);

        return APIResponse<IEnumerable<EngineerCategoryResposne>>.SuccessResponse(categories, APIStatusCodes.OK);
    }
}
